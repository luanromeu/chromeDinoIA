...
- **Segundo Teste:**  
  ...
  - **Resultados:**  
    ...
    - Após apenas 15 gerações, a rede ainda tomava decisões aleatórias, como pular sem critério e nao conseguiu alcancar nem 100 pontos.
...
*Exemplo:* Ao iniciar a simulação, o jogo pode ser configurado para começar em uma velocidade definida, acelerando o treinamento ao evitar a fase de velocidades mais baixas.
...
1. **Pré-requisitos:**
   ...
   - As dependências listadas na seção de Dependências.

2. **Instalação:**
   - Clonar o repositório.
   - Acessar a pasta do projeto.
   - Executar a instalação das dependências (npm install).

3. **Execução:**
   - Executar npm start ou node index.js na pasta raiz do projeto

4. **Monitoramento e Debug:**
   - O projeto inclui uma interface de debug que sobrepõe informações no canvas do jogo, exibindo dados dos sensores e ativações em tempo real, no arquivo GameManipulator.js basta setar a   variavael "debug" como true.
